/**
 * Skill-studio trust fence: loopback (the desktop) always passes; a live
 ...
 * fence stays loopback-only (same pattern as the family's skill-explorer).
 */
...
/**
 * Whether this request may enter any /api/dsh-skill-studio route.
 * @param ctx - host context; may expose remoteWebUiPairing.
 * @param request - the incoming HTTP request.
 * @returns true for loopback, or a live paired-device cookie.
 */
export function isSkillStudioAllowed(ctx: Context, request: IncomingMessage): boolean {
