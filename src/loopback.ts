/**
 * Loopback trust fence for the host route family: socket address, Host
 * header, and browser same-origin markers (ported from the dsh-web-ui
 * family's shared implementation).
 *
